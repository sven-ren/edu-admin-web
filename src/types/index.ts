...
export const SEA_PETS: SeaPet[] = [
  ...
  { 
    id: 'jellyfish', 
    name: '水母', 
    stages: ['/src/imgs/jellyfish1.jpg', '/src/imgs/jellyfish2.jpg', '/src/imgs/jellyfish3.jpg', '/src/imgs/jellyfish4.jpg', '/src/imgs/jellyfish5.jpg'],
    type: 'image'
  },
];
...
export const ACTION_ITEM_EMOJIS = ['🗣️', '📝', '🤝', '👂', '⭐', '⏰', '📕', '💬', '🎤', '🧹', '✨', '🎯', '💡', '🎨', '🎵'];
